...
use "$ACSbuild/cleaned/acs_cleaned.dta" if inrange(year, `yr1', `yr2'), clear
drop if missing(sector, occ3d2010)

merge m:1 occ3d2010 using `occ3dtemp', nogen keepusing(wfhflex3digit)
...
#delimit ;
merge m:1 occ3d2010 using "$ACSbuild/cleaned/occ_group_stats.dta",
